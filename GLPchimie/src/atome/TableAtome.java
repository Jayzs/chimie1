...
public enum TableAtome {
	...
	Fermium("Fèrmium","Fm","257","100","253.0"),
	Mendelevium("Mendélevium","Md","258","101","256.0"),
	Nobelium("Nobélium","No","259","102","254.0"),
	Lawrencium("lawrencium","Lr","260","103","257.0");
	
private final String z; // numéro atomique
